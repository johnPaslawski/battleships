...
def implacement_phase_pl_vs_pl(board_dimension):
    ...
    implacement_phase_player_1(ship_types, board_dimension, list_of_forbidden_coordinates, rows_letters)
    implacement_phase_player_2(ship_types, board_dimension, list_of_forbidden_coordinates, rows_letters)

def implacement_phase_player_1(ship_types, board_dimension, list_of_forbidden_coordinates, rows_letters):
...
def implacement_phase_player_2(ship_types, board_dimension, list_of_forbidden_coordinates, rows_letters):
    player_2_board = init_player_2_board(board_dimension)
    print_player_2_board(board_dimension, player_2_board, rows_letters)
    for ship_type_number in range(0,5):
        valid_coordinates = get_placement_coordinates(ship_type_number, ship_types, player_2_board, list_of_forbidden_coordinates, rows_letters, player_1_board)
