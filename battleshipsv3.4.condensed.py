...
def what_is_shot_effect(coordinates, placed_ships, ship_separate_list):
    
    patrol_boat_1 = ship_separate_list[0]
    patrol_boat_2 = ship_separate_list[1]
    destroyer_1 = ship_separate_list[2]
    destroyer_2 = ship_separate_list[3]
    aircraft_carrier = ship_separate_list[4]
...
def mark_shot_effect_on_board(board, shoot_effect, coordinates, ship_separate_list):
    ...
    if shoot_effect == 'M' or shoot_effect == 'H': 
        ...
        elif [coordinates[1], coordinates[2]] in destroyer_1:
            board[destroyer_1[0][0]][destroyer_1[0][1]] = shoot_effect
            board[destroyer_1[1][0]][destroyer_1[1][1]] = shoot_effect

        elif [coordinates[1], coordinates[2]] in destroyer_2:
            board[destroyer_2[0][0]][destroyer_2[0][1]] = shoot_effect
            board[destroyer_2[1][0]][destroyer_2[1][1]] = shoot_effect

        elif [coordinates[1], coordinates[2]] in aircraft_carrier:
            board[aircraft_carrier[0][0]][aircraft_carrier[0][1]] = shoot_effect
            board[aircraft_carrier[1][0]][aircraft_carrier[1][1]] = shoot_effect
            board[aircraft_carrier[2][0]][aircraft_carrier[2][1]] = shoot_effect
    else:
        pass
...
ship_separate_list_pl_1 = get_ship_placement_separate_list(list_of_ships_coordinates_pl_1)
ship_separate_list_pl_2 = get_ship_placement_separate_list(list_of_ships_coordinates_pl_2)
...
while True:
    ...
    shoot_effect = what_is_shot_effect(coordinates, pl_2_placed_ships, ship_separate_list_pl_2)
    mark_shot_effect_on_board(player_2_shooting_board, shoot_effect, coordinates, ship_separate_list_pl_2)
    print_both_boards(board_dimension, player_1_shooting_board, player_2_shooting_board)
    
    print(f'NOW {player} TURN')
    coordinates = get_shot_coordinates(board_dimension)
    shoot_effect = what_is_shot_effect(coordinates, pl_1_placed_ships, ship_separate_list_pl_1)
    mark_shot_effect_on_board(player_1_shooting_board, shoot_effect, coordinates, ship_separate_list_pl_1)
    print_both_boards(board_dimension, player_1_shooting_board, player_2_shooting_board)