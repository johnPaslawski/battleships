...
def check_if_coordinates_valid_implacement_phase(coordinates_given_by_user, player_1_board, board_dimension, ship_type_number, list_of_forbidden_coordinates, rows_letters):
    ...
    try:
        is_not_too_close = mark_occupied_and_forbidden_fields_on_board_in_placement_phase(player_1_board, coordinates, ship_type_number, list_of_forbidden_coordinates)
    except:
        return invalid_input
...
def get_placement_coordinates(ship_type_number, ship_types, list_of_forbidden_coordinates, rows_letters):
...
def print_player_1_board(board_dimension, player_1_board, rows_letters):
    print('    ', end='')
...
def print_player_2_board(board_dimension, player_2_board, rows_letters):
    print('    ', end='')
    for k in range(0,board_dimension):
        print(str(k+1) + '  ', end='')
    print('\n')
...
def implacement_phase_pl_vs_pl(board_dimension):
    ...
    implacement_phase_player_1(ship_types, board_dimension, player_1_board, list_of_forbidden_coordinates, rows_letters)
    implacement_phase_player_2(ship_types, board_dimension, player_2_board, list_of_forbidden_coordinates, rows_letters)

def implacement_phase_player_1(ship_types, board_dimension, player_1_board, list_of_forbidden_coordinates, rows_letters):
    print_player_1_board(board_dimension, player_1_board, rows_letters)
    for ship_type_number in range(0,5):
        valid_coordinates = get_placement_coordinates(ship_type_number, ship_types, list_of_forbidden_coordinates, rows_letters)
        put_ship_on_board(player_1_board, valid_coordinates, ship_type_number)
        print_player_1_board(board_dimension, player_1_board, rows_letters)

def implacement_phase_player_2(ship_types, board_dimension, player_2_board, list_of_forbidden_coordinates, rows_letters):
    print_player_2_board(board_dimension, player_2_board, rows_letters)
    for ship_type_number in range(0,5):
        valid_coordinates = get_placement_coordinates(ship_type_number, ship_types, player_2_board, list_of_forbidden_coordinates, rows_letters)
