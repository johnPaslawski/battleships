...
def init_player_board(board_dimension):
    board = [[colored('O', 'grey')] * board_dimension for _ in range(board_dimension)]
    return board
...
def what_is_shot_effect(coordinates, placed_ships, patrol_boat_1, patrol_boat_2, destroyer_1, destroyer_2, aircraft_carrier):
    ...
    if placed_ships[coordinates[1]][coordinates[2]] == colored('O', 'grey'):
        return 'M'
...
def mark_shot_effect_on_board(board, shoot_effect, coordinates, patrol_boat_1, patrol_boat_2, destroyer_1, destroyer_2, aircraft_carrier):
    ...
    if shoot_effect == 'M':
        ...
        board[coordinates[1]][coordinates[2]] = colored('H', 'yellow')
    elif shoot_effect == 'S':
        if [coordinates[1], coordinates[2]] == patrol_boat_1:
            board[coordinates[1]][coordinates[2]] = colored('S', 'red')
        ...
        if destroyer_1[0] == 'S' and destroyer_1[1] == 'S':
            board[coordinates[1]][coordinates[2]] = colored('S', 'red')
            try:
                if board[coordinates[1]+1][coordinates[2]] == colored('H', 'yellow'):
                    board[coordinates[1]+1][coordinates[2]] = colored('S', 'red')
            except:
                pass
            try:
                if board[coordinates[1]][coordinates[2]+1] == colored('H', 'yellow'):
                    board[coordinates[1]][coordinates[2]+1] = colored('S', 'red')
            except:
                pass
            try:
                if board[coordinates[1]][abs(coordinates[2]-1)] == colored('H', 'yellow'):
                    board[coordinates[1]][abs(coordinates[2]-1)] = colored('S', 'red')
            except:
                pass
            try:
                if board[abs(coordinates[1]-1)][coordinates[2]] == colored('H', 'yellow'):
                    board[abs(coordinates[1]-1)][coordinates[2]] = colored('S', 'red')
            except:
                pass
        ...
        if aircraft_carrier[0] == 'S' == aircraft_carrier[1] == aircraft_carrier[2]:
            ...
            try:
                if board[coordinates[1]+1][coordinates[2]] == colored('H', 'yellow'):
                    board[coordinates[1]+1][coordinates[2]] = colored('S', 'red')
                    try:
                        if board[coordinates[1]+2][coordinates[2]] == colored('H', 'yellow'):
                            board[coordinates[1]+2][coordinates[2]] = colored('S', 'red') 
                    except:
                        pass       
            except:
                pass 
            try:
                if board[coordinates[1]][coordinates[2]+1] == colored('H', 'yellow'):
                    board[coordinates[1]][coordinates[2]+1] = colored('S', 'red')
                    try:
                        if board[coordinates[1]][coordinates[2]+2] == colored('H', 'yellow'):
                            board[coordinates[1]][coordinates[2]+2] = colored('S', 'red')
                    except:
                        pass
            except:
                pass
            try:
                if board[coordinates[1]][abs(coordinates[2]-1)] == colored('H', 'yellow'):
                    board[coordinates[1]][abs(coordinates[2]-1)] = colored('S', 'red')
                    try:
                        if board[coordinates[1]][abs(coordinates[2]-2)] == colored('H', 'yellow'):
                            board[coordinates[1]][abs(coordinates[2]-2)] = colored('S', 'red')
                    except:
                        pass
            except:
                pass
            try:
                if board[abs(coordinates[1]-1)][coordinates[2]] == colored('H', 'yellow'):
                    board[abs(coordinates[1]-1)][coordinates[2]] = colored('S', 'red')
                    try:
                        if board[abs(coordinates[1]-2)][coordinates[2]] == colored('H', 'yellow'):
                            board[abs(coordinates[1]-2)][coordinates[2]] = colored('S', 'red')
                    except:
                        pass
            except:
                pass
...
def print_shoot_effect(shoot_effect):
    '''if shoot_effect = 'M'
        ...
        print('SHIP JUST SUNK, GRATULATIONS')'''
...
while True:
    ...
    #dopisać licznik tur
    #dopisać metode liczącą punkty (dodaje punkt za hita  dwa punkty za zatopienie)
    #dopisać metodę has_won, która sprawdza czy zostały zatopione wszystkie statki
    #dopisać print_result