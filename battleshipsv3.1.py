...
def wait_for_press_in_placem_phase():
...
def get_placement_coordinates(ship_type_number, ship_types, list_of_forbidden_coordinates, rows_letters, board):
    ...
    if ship_type_number == 0 or ship_type_number == 1:
        while not checking_result_of_user_input == 'coord_valid':      
            ...
            coordinates_given_by_user = newmethod691(board, ship_type_number, list_of_forbidden_coordinates, rows_letters, coordinates_given_by_user)
...
def newmethod691(board, ship_type_number, list_of_forbidden_coordinates, rows_letters, coordinates_given_by_user):
