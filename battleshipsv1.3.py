...
def get_placement_coordinates(ship_type_number, ship_types, board_copy, list_of_forbidden_coordinates):
    ...
    if ship_type == ship_types[0]:
        while not checking_result == 'coord_valid':      
            ...
            checking_result = check_if_coordinates_valid_implacement_phase(coordinates_given_by_user, board_copy, board_dimension, ship_type_number, list_of_forbidden_coordinates)          
...
def implacement_phase_player_1(ship_types, board_dimension, player_1_board):
    ...
    for ship_type_number in range(0,5):
        get_placement_coordinates(ship_type_number, ship_types, player_1_board, list_of_forbidden_coordinates)
...
def implacement_phase_player_2(ship_types, board_dimension, player_2_board):
    ...
    list_of_forbidden_coordinates = []
    for ship_type_number in range(0,5):
        get_placement_coordinates(ship_type_number, ship_types, player_2_board, list_of_forbidden_coordinates)
